...
public class AdapterItem extends RecyclerView.Adapter<AdapterItem.viewHolder>
{
    ...
    public AdapterItem(Context context, List<ModelItem> modelItemList)
    {
    ...
    @NonNull
    @Override
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int holder)
    {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position)
    {
        ...
        final ModelItem item = modelItemList.get(position);
        holder.textfreeprice.setVisibility(View.GONE);
        holder.textvisite.setText(item.getVisit());
        holder.texttitle.setText(item.getTitle());
        holder.textprice.setText(item.getPrice() + " " + "تومان");
        ...
        } else
        {
            ...
            holder.textfreeprice.setText(item.getFreeprice() + " " + "تومان");
